...
const processors = {
   ...
   * p.amount es el monto FINAL (rebaja ya restada); la rebaja viaja en
   * p_discount (migración 11). */
  ...
  /* Fiar apartado de Live (RPC con anti doble-fiado). Igual que
   * live_collect: amount es FINAL y discount viaja aparte. */
